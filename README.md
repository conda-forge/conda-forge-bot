...
- `BOT_INTEGRATION_TESTING`: set if the bot is running integration tests
...
this repository and hosted via `quay.io`. The `__version__` tag is used for production jobs and updated automatically
