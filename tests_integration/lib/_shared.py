...
def get_transparent_urls() -> set[str]:
    ...
    """
    transparent_urls = {
        "https://raw.githubusercontent.com/conda-forge/conda-forge-bot-data/main/mappings/pypi/name_mapping.yaml",
        "https://raw.githubusercontent.com/conda-forge/conda-forge-bot-data/main/mappings/pypi/grayskull_pypi_mapping.json",
        ...
        f"https://raw.githubusercontent.com/{GitHubAccount.REGRO_ORG}/*",
        f"https://raw.githubusercontent.com/{GitHubAccount.CONDA_FORGE_ORG}/*",
        f"https://raw.githubusercontent.com/{GitHubAccount.BOT_USER}/*",
